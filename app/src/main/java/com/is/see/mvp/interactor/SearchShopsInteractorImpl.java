...
public class SearchShopsInteractorImpl extends Retrofit2See implements CommonListInteractor {
    ...
    public SearchShopsInteractorImpl(Context context, BaseMultiLoadedListener<SearchShopsResponse> loadedListener) {
        super(context);
    ...
    public void getCommonListData(final int event, JSONObject json){
        ...
        Call<SearchShopsResponse> call = seeApi.searchshops(
